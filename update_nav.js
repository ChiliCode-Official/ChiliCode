...
function getConsistentNavLinks(activePage) {
    const active_idx = activePage === 'index' ? ' class="active"' : '';
    const active_nos = activePage === 'nosotros' ? ' class="active"' : '';
    const active_art = activePage === 'artesanias' ? ' class="active"' : '';
    const active_sta = activePage === 'startups-experience-high' ? ' class="active"' : '';
    const active_exp = activePage === 'express' ? ' class="active"' : '';
